...
using System.Data.SQLite;
    ...
    public abstract class SQLiteHelper
    {
        ...
        public static string LogConStr = "LogData";
        public SQLiteHelper()
        {
        }
        ...
        #endregion
        #region 创建数据库
        public static string CreatDB(string fileName,string password)
        {
            try
            {
                string[] parmArr=new string[] { "Data Source=",fileName,";Version=3;"};
                string conntr = string.Concat(parmArr);
                SQLiteConnection conn=new SQLiteConnection(conntr);
                conn.Open();
                //为数据库设置密码
        ...
        public static void CreatDB(string fileName)
        {
            if (!string.IsNullOrEmpty(fileName))
            {
                try { SQLiteConnection.CreateFile(fileName); }
        ...
        public static DataRow ExecuteDataRow(string sql, params SQLiteParameter[] parameters)
        {
            using (SQLiteConnection connection = new SQLiteConnection(connectionString))
            {
                using (SQLiteCommand command = new SQLiteCommand(sql, connection))
        ...
        public static int ExecuteSql(string constr,string SQLString, params SQLiteParameter[] cmdParms)
        {
        ...
        public static int ExecuteSql(string constr, string SQLString)
        {
            using (SQLiteConnection connection = new SQLiteConnection(constr))
            {
                using (SQLiteCommand cmd = new SQLiteCommand())
